...
<body>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
		...
		<ul class="navbar-nav">
			<li class="nav-item"><a class="nav-link" href="#">Add player</a></li>
	...
	<div class="container">
		...
		<form:form class="form-horizontal" data-toggle="validator" role="form" modelAttribute="student"
			action="${pageContext.request.contextPath}/student/edit/${student.rank}.html" method="post">
			<div class="form-group">
				<label class="control-label col-sm-2">Student Name:</label>
				<div class="col-sm-4">
					<form:input path="name" pattern="^[a-zA-Z]+(\s[a-zA-Z]+)?$" maxlength="25" data-error="Please provide your name." class="form-control"
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<form:input class="form-control" path="email" data-error="Invalid Email or Field is Empty" placeholder="Email" required="required" />
					<div style="color: red" class="help-block with-errors"></div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-4">
					<form:input placeholder="Phone" required="required" maxlength="10" class="form-control" pattern="^(\+91[\-\s]?)?[0]?(91)?[789]\d{9}$"
						path="phone" data-error="Not a valid Number." />
					<div style="color: red" class="help-block with-errors"></div>
				</div>
			</div>
			<div class="form-group">
